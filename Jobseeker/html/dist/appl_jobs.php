        ...
        <nav class="page-sidebar" id="sidebar">
            <div id="sidebar-collapse">
                <div class="admin-block d-flex">
					...
					$sq="SELECT * FROM user_reg INNER JOIN tbl_login ON user_reg.login_id=tbl_login.login_id WHERE tbl_login.username ='$_SESSION[User]'";
                ...
                <ul class="side-menu metismenu">
                    ...
                    <li>
                        ...
                        <ul class="nav-2-level collapse">
                            ...
                            <li>
                                <a href="appl_jobs.php">View Applied Jobs</a>
                            </li>
                    ...
                    <li>
                        ...
                        <ul class="nav-2-level collapse">
                            <li>
                                <a href="sendnotify.php">Send Notification</a>
                            </li>
                            <li>
                                <a href="viewnotify.php">View Notification</a>
                            </li>
...
include 'connect.php';
       ...
       $sqli = "SELECT * FROM applied_jobs inner join job_post on  applied_jobs.job_id=job_post.job_id   WHERE applied_jobs.user_id ='$user'";
	  ...
	  <td> <?php echo $row['job_title']; ?> </td>
       ...
       ?>                       
            ...
            <footer class="page-footer">
                <div class="font-13"> <b>Company</b> - All rights reserved.</div>
        ...
        <div class="theme-config-box">
            ...
            <div class="check-list m-b-20 m-t-10">
                <label class="ui-checkbox ui-checkbox-gray">
                    <input id="_fixedNavbar" type="checkbox" checked="True">
                    <span class="input-span"></span>Fixed navbar</label>
                <label class="ui-checkbox ui-checkbox-gray">
                    <input id="_fixedlayout" type="checkbox" checked="True">
