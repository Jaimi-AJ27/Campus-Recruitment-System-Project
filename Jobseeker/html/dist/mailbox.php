...
<head>
    ...
    <title>Admincast bootstrap 4 &amp; angular 5 admin template, Шаблон админки | Mailbox</title>
                ...
                <ul class="side-menu metismenu">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav-2-level collapse in">
                            <li>
                                <a class="active" href="mailbox.html">Inbox</a>
                            </li>
                            <li>
                    ...
                    <div class="col-lg-3 col-md-4">
                        ...
                        <ul class="list-group list-group-divider inbox-list">
                            <li class="list-group-item">
                                <a href="javascript:;"><i class="fa fa-inbox"></i> Inbox
                                    <span class="badge badge-warning badge-square pull-right"></span>
                                </a>
                            </li>
                            <li class="list-group-item">
