            ...
            <div class="page-content fade-in-up">
                ...
                <div class="ibox">
                    <div class="ibox-head">
					  ...
					  <?php 
		$sql="SELECT * FROM company_reg where reg_id='$regid'";
               ...
               ?>
                    ...
                    <div class="ibox-body">
                        <form class="form-horizontal" id="form-sample-1" method="post" novalidate="novalidate" action="updatecom.php">
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Company</label>
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="cname" value="<?php echo $row['company_name']; ?> ">
                                </div>
                            </div>
							 <div class="form-group row">
