            ...
            <div class="page-content fade-in-up">
                ...
                <div class="ibox">
                    <div class="ibox-head">
					  ...
					  <?php 
		$sql="SELECT * FROM user_reg where user_id='$uid'";
               ...
               ?>
                    ...
                    <div class="ibox-body">
                        <form class="form-horizontal" id="form-sample-1" method="post" novalidate="novalidate" action="updatejobseeker.php">
                            ...
                            <div class="form-group row">
							 ...
							 <div class="form-group row">
                                ...
                                <div class="col-sm-10">
									...
									<input class="form-control" type="hidden" name="userid" value="<?php echo "$uid"; ?> ">
                                </div>
                            </div>
