...
?>						
              <?php
                $sql = "SELECT * FROM user_reg where Status=1";
	  ...
	  <td> <?php echo $row['dob']; ?> </td>
	   ...
	   <form action="updatejobseeke.php" method="post">
	  <td><input type="hidden" name="uid" value="<?php echo $row['user_id'];?>">
	<button class="btn btn-primary">Update</button>
	</td>
	</form>
	   <form action="deletejobseeker.php" method="post">
	  <td><input type="hidden" name="userid" value="<?php echo $row['user_id'];?>">
