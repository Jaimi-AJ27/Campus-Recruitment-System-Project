                    ...
                    <div class="col-lg-9 col-md-8">
                        <div class="ibox" id="mailbox-container">
                            ...
                            <div class="mailbox-body">
                                <form class="form-horizontal" action="mail.php" method="POST" if="compose_form">
                                    <div class="form-group row">
                                        <label class="col-sm-2 control-label">To:</label>
                                        <div class="col-sm-10">
                                            <input class="form-control" type="text" name="to" autocomplete="off" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <textarea id="summernote" name="message" autocomplete="off" required>
