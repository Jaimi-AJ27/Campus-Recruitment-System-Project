...
?>						
              <?php
                $sql = "SELECT * FROM applied_jobs inner join job_post on job_post.job_id=applied_jobs.job_id inner join user_reg on applied_jobs.user_id=user_reg.user_id where job_post.reg_id='$regid' ";
